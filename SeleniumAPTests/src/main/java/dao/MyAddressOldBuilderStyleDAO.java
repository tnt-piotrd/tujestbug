...
public class MyAddressOldBuilderStyleDAO {
    ...
    public MyAddressOldBuilderStyleDAO(String firstName, String lastName, String company, String addressLine, String addressLine2, String city, String state, String zipPostalCode, String homePhone, String mobilePhone, String additionalInfo, String addressAliasName) {
    ...
    public static class Builder {
        ...
        public MyAddressOldBuilderStyleDAO build() {
            return new MyAddressOldBuilderStyleDAO(firstName, lastName, company, addressLine, addressLine2, city, state, zipPostalCode,
